...
import { CTACard, SectionHeading, RevealOnScroll } from '../shared/Components';
              ...
              <div className="mb-10 relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8 relative z-20">
                  <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-sm font-display font-bold uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] active:scale-95 flex items-center justify-center gap-2 group w-full sm:w-auto"
                  >
          ...
          {match ? (
            ...
            <div className="bg-[#1a2a4a] rounded-xl border border-white/10 p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button 
                  onClick={() => navigateTo('join')}
                  className="bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase px-10 py-4 rounded transition-colors shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] flex items-center justify-center gap-2 mx-auto active:scale-95"
                >
