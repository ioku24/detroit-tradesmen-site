      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-4">
          {matches.map((match, idx) => (
            <RevealOnScroll key={match.id} delay={idx * 100}>
              <div 
                className="bg-[#1a2a4a]/60 border border-white/5 rounded-lg p-6 flex flex-col md:flex-row items-center justify-between hover:bg-[#1a2a4a] transition-all"
              >
